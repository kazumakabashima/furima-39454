class Item < ApplicationRecord
  ...
  validates :burden_id,       numericality: { other_than: 1 , message: "burden can't be blank" } 
  validates :prefecture_id,   numericality: { other_than: 1 , message: "prefecture can't be blank" } 
  validates :shipping_day_id, numericality: { other_than: 1 , message: "shipping_day can't be blank" } 
